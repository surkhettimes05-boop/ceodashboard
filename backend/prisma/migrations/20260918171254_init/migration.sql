-- CreateEnum
CREATE TYPE "RoleType" AS ENUM ('CEO', 'ADMIN', 'MANAGER', 'WAREHOUSE_MANAGER', 'CASHIER', 'ACCOUNTANT', 'B2B_SALES', 'PURCHASING');

-- CreateEnum
CREATE TYPE "SalesChannel" AS ENUM ('RETAIL', 'B2B', 'ONLINE');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'CARD', 'MOBILE_MONEY', 'BANK_TRANSFER', 'CREDIT');

-- CreateEnum
CREATE TYPE "InventoryMovementType" AS ENUM ('SALE', 'PURCHASE', 'TRANSFER_IN', 'TRANSFER_OUT', 'RETURN', 'ADJUSTMENT', 'DAMAGE', 'OPENING_STOCK');
